...
#any string starts or ends with only AUCG or aucg 
    rna_pattern_str = r'^[AUCGaucg]*$'
#any string starts or ends with only ATCG or atcg    
...
def vet_codon(codon):
    ...
    # only valid codons.
    # Read the docstring above for additional clues.
#any string starts or ends with only these characters (three of them at a time = codon) 
